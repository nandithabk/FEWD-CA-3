...
function fetchRandomMeal() {
    ...
    fetch("https://www.themealdb.com/api/json/v1/1/random.php")
        ...
        .then(data => {
            // Extract dish name and image URL
            ...
            imageElement.setAttribute("src", dishImage);
            imageElement.setAttribute("alt", dishName);

            // Create a heading element
            const headingElement = document.createElement("h2");
            headingElement.innerText = `Dish Name: ${dishName}`;

            // Append the image and heading to the div
            dishDiv.appendChild(headingElement);
            dishDiv.appendChild(imageElement);

            // Append the new div after the existing content
            document.body.appendChild(dishDiv);
        })
